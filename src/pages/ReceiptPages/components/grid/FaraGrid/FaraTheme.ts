    ...
    components: ({
        MuiDataGrid: {
            styleOverrides: {
                ...
                columnHeaders: {
                    background: "linear-gradient(180deg,#dce8f8 0%,#c8d9ef 100%) !important",
                ...
                sortIcon: { fontSize: 12, color: "#1a6fc4" },
                row: {
                    minHeight: "22px !important",
                    maxHeight: "22px !important",
                    "&:nth-of-type(odd)": { backgroundColor: "#f7faff" },
                    "&:nth-of-type(even)": { backgroundColor: "#ffffff" },
                    "&:hover": { backgroundColor: "#dceeff !important" },
                    "&.Mui-selected": {
                        backgroundColor: "#b8d4f0 !important",
                        "&:hover": { backgroundColor: "#a0c4e8 !important" },
                    },
                },
                cell: {
                    ...
                    alignItems: "center",
                    color: "#1a1a1a",
                    "&.MuiDataGrid-cell--editable:hover": { cursor: "text" },
                ...
                virtualScroller: {
                    ...
                    "&::-webkit-scrollbar-track": { background: "#f0f4fa", border: "1px solid #b8cce4" },
                    "&::-webkit-scrollbar-thumb": {
                        background: "linear-gradient(180deg,#c8d9ef,#a0bdd8)",
                        border: "1px solid #94b8d8",
                        borderRadius: 2,
                    },
                    "&::-webkit-scrollbar-thumb:hover": { background: "linear-gradient(180deg,#b0cce8,#88aac8)" },
                    "&::-webkit-scrollbar-corner": { background: "#f0f4fa" },
                },
